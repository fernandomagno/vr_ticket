...
describe('VR Negativo', () => {
    it('Validação de cenario negativo', () => {
      cy.visit('/')
      ...
      cy.get('[data-item="24725081000155"] > .info-estab__title').should("have.text", "SAMS CLUB");
      cy.get('[data-item="45581099000109"] > .info-estab__title').should("have.text", "BLA BLA BLA");
